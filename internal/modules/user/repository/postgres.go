...
func (r *PostgresRepository) UpsertDevUser(ctx context.Context, email string) (*domain.User, error) {
	const q = `
INSERT INTO users (
    id,
    email,
...
func (r *PostgresRepository) UpsertWalletUser(ctx context.Context, id, email, displayName string) (*domain.User, error) {
	const q = `
INSERT INTO users (
    id,
    email,
...
func (r *PostgresRepository) UpdateDisplayName(ctx context.Context, id, displayName string) (*domain.User, error) {
	const q = `
UPDATE users
SET
    display_name = $2,
